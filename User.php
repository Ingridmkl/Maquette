    ...
    <div class="header">
        <div class="side-nav">
            <div class="user">
                ...
                <ul>
                    <li><a href="#anchor1"><p>Informations utilisateur</p></a></li> <!--rajouter des icones entre le li et le p si tu veux-->
        ...
        <div class="right-content">
            ...
            <div id="anchor6" class="restoManagement">
                ...
                A modifier en .php pour l'ajout/ suppression des restaurants</div>
            </div>
        </div>
    </div>
</body>
